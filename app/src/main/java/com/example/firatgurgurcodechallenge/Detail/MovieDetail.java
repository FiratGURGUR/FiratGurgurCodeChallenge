...
public class MovieDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statics.setTransparetStatusBar(MovieDetail.this);
    ...
    public void loadCrew() {
        ...
        castCrewAdapter = new CastCrewAdapter(castCrewModelList, MovieDetail.this, new CustomItemClickListener() {
            @Override
    ...
    public void getMovieDetail(int id) {
        ...
        apiClass.getMovieDetail(handler, id);
    }

    public void getCastCrewPeople(int id) {
        apiClass = new APIClass();
        apiClass.getCastAndCrew(handler, id);
    }
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case 0:
                    break;
                case 1:
                    final MModel model = (MModel) msg.obj;
    ...
    public void loadContent(MModel model) {
        movieName = model.getTitle();
        ...
        Glide.with(context)
                ...
                .load(URLList.IMAGE_BASE_URL + model.getBackdrop_path()).into(backImage);

        Glide.with(context)
                .setDefaultRequestOptions(requestOptions)
                .load(URLList.IMAGE_BASE_URL + model.getPoster_path())
                .into(posterImage);

        movie_name.setText(model.getTitle());
        movie_overview.setText(model.getOverview());
        movie_vote_avg.setText(String.valueOf(model.getVote_average()));

        List<MModel.Genres> genres = model.getGenres();
